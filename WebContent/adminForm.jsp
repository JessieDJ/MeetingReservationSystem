									...
									<div class="clearfix">
										<div class="nav-collapse nav-collapse_">
											<ul class="nav sf-menu clearfix">
                                                ...
                                                <li class="active"><a href="adminForm.jsp">Reserve Meeting Room</a></li>
                                                <li></li>
											</ul>
										</div>
									</div>
		...
		<div class="container">
			<div class="row">
				...
				<article class="span8 form-box">
					<div>
						<br>
						<h5 style="color: white">Please enter the meeting room</h5>
						<s:form action="login">
							<s:textfield name="roomNumber" label="Room Number"></s:textfield>
